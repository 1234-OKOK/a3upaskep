...
["blackMarketStock", [
    ...
    ["UK3CB_CW_US_B_LATE_C130J", 6000, "PLANE", {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}],
    ["UK3CB_CW_US_B_LATE_C130J_CARGO", 6000, "PLANE", {{sidesX getVariable [_x,sideUnknown] isEqualTo teamPlayer} count airportsX > 0}],
